...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Your_Session_Id",DcwxBbBJ#c3EEkUBzImNHXHyNyEoQGT0It79y_PzKrKjj29kn-w4 // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94721039312",
DEV: process.env.DEV || "94721039312",
...
WELCOME: process.env.WELCOME || "𝗛𝗜 ❤️😉",
GOODBYE: process.env.GOODBYE || "𝗯𝘆𝗲 🩵😭",
